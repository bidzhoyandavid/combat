...
4. `ModelAggregation(models_dict, metric, check_sample)` - perform aggregation of multiple models to leverage their collective predictive capabilities

5. `PredictionAggregation(models_dict, weights_dict, x_data)` - aggregate predictions generated by multiple models to produce a consolidated prediction output              
