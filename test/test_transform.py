...
class Test_Transform():
    ...
    @pytest.mark.parametrize(
            ...
            , [
                # (x[name], y, -1,  name, 'numerical', 'woe', special_codes,  'cp', None, 'iv', 'cart', 20, does_not_raise())
                ...
                # , (x[name_1], y, -1,  name_1, 'numerical', 'woe', special_codes,  'mip', 0.05, 'js', 'quantile', 20, does_not_raise())
                ...
                # , (x[name_1], y, -1,  name_1, 'numerical', 'woe', special_codes,  'ls', 0.05, 'iv', 'uniform', 20, does_not_raise()) # problrm occurs ---------------------
                 (x[name_2], y, -1,  name_2, 'numerical', 'woe', special_codes,  'cp', 0.05, 'iv', 'cart', 20, does_not_raise())
    ...
    @pytest.mark.parametrize(
            ...
            , [
                (x, y, df_sign, 'woe', 'iv', 'cart', 20, 0.05, False, None, does_not_raise())
                # , (x, y, df_sign, 'event_rate', 'iv', 'cart', 20, 0.4, None, False, does_not_raise())
                # , (x, y, df_sign, 'woe', 'js', 'cart', 20, 0.4, False, None, does_not_raise())
                # , (x, y, df_sign, 'woe', 'iv', 'mdlp', 20, 0.4, False, None, does_not_raise())
                # , (x, y, df_sign, 'woe', 'iv', 'uniform', 20, 0.4, False, None, does_not_raise())
